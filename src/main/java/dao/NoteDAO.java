...
public class NoteDAO  {
    ...
    private final String SORT_BY_DESCRIPTION = "SELECT n.*, t.name_note as note, t.description as descrip FROM note n " +
            "JOIN note_type t ON n.type_id = t.id order by t.name_note";
    ...
    public List<Note> sortByNoteType(){
        List<Note> notes = new ArrayList<>();
        try ( Connection connection = getConnection();
