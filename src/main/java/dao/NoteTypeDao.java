...
public class NoteTypeDao {
    ...
    private final String SORT_BY_ID = "SELECT * FROM note_type order by id desc;";
    private final String SORT_BY_NAME_NOTE = "SELECT * FROM note_type order by name_note;";
    private final String SORT_BY_DESCRIPTION = "SELECT * FROM note_type order by `description` desc;";
    ...
    public List<NoteType> sortByDescription(){
        List<NoteType> noteTypes = new ArrayList<>();
        try ( Connection connection = getConnection();
              PreparedStatement preparedStatement = connection.prepareStatement(SORT_BY_DESCRIPTION)
        ){
    ...
    public List<NoteType> sortByNameNote(){
        List<NoteType> noteTypes = new ArrayList<>();
        try ( Connection connection = getConnection();
              PreparedStatement preparedStatement = connection.prepareStatement(SORT_BY_NAME_NOTE)
        ){
            ResultSet resultSet = preparedStatement.executeQuery();
            while (resultSet.next()) {
                int id = resultSet.getInt("id");
