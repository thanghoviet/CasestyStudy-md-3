...
public class NoteServlet extends HttpServlet {
        ...
        try {
            switch (action) {
                ...
                case "sort-Date":
                    ...
                    break;
                case "sort-note-type":
                    sortWithNoteType(request,response);
                    break;
                case "search":
    ...
    private void sortWithNoteType(HttpServletRequest request, HttpServletResponse response)
            throws SQLException, IOException, ServletException {
        List<Note> listNote = noteDAO.sortByNoteType();
        request.setAttribute("listNote", listNote);
        RequestDispatcher dispatcher = request.getRequestDispatcher("listTable.jsp");
        dispatcher.forward(request, response);
    }
