                    ...
                    <div class="row">
                            ...
                            <div class="table-data__tool-left">
                                <a href="note"
                                   class="au-btn au-btn-icon au-btn--green au-btn--small"> <i
                                        class="zmdi zmdi-collection-item"></i>Back list
                                </a>
                            </div>
                        ...
                        <div class="table-data__tool">
                            <div class="table-data__tool-left">
                                <a href="type"
                                   class="au-btn au-btn-icon au-btn--green au-btn--small"> <i
                                        class="zmdi zmdi-collection-item"></i>Back List Type
                                </a>
                            </div>
                            <div class="table-data__tool-right"></div>
                        </div>
                        ...
                        <div class="col-12 col-md-12">
                            <form action="" method="post" class="form-horizontal">
                                <div class="card-header">
                                    <strong>Edit Note Type</strong>
                                </div>
                                <div class="card-body card-block">
                                    <div class="row form-group">
                                        <div class="col col-md-3">
                                            <label for="name_note" class=" form-control-label">Name Note</label>
                                        </div>
                                        <div class="col-12 col-md-9">
                                            <input type="text" id="name_note" name="name_note" placeholder="name note"
                                                   required value="${noteType.name_note}" class="form-control">
<%--                                            <input type="hidden" name="date" value="${note.datetime}">--%>
                                        </div>
                                    </div>
                                    <div class="row form-group">
                                        <div class="col col-md-3">
                                        ...
                                        <div class="col-12 col-md-9">
                                            <input type="text" id="description" name="description"
                                                   placeholder="description" value="${noteType.description}"
                                                   class="form-control">
                                        </div>
                                    </div>
<%--                                    <div class="row form-group">--%>
...
<%--                                                <c:forEach items="${listNoteType}" var="type">--%>
<%--                                                    <option value="${type.id}">${type.name_note}</option>--%>
<%--                                                </c:forEach>--%>
<%--                                            </select>--%>
<%--                                        </div>--%>
<%--                                    </div>--%>
