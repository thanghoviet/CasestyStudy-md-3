...
<div class="card">
    ...
    <div id="login-edit" class="container" style="max-width: 417px;">
        <div class="card-body card-block">
            <form action="${pageContext.request.contextPath}/account" method="post" class="">
                <input type="hidden" name="action" value="login">
                <div class="form-group">
                    <label for="use_name" class=" form-control-label">Login</label>
                    <input type="text" id="use_name" name="use_name" placeholder="your account..."
                           class="form-control">
