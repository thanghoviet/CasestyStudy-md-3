                        ...
                        <div class="col-12 col-md-12">
                            <form action="" method="post" class="form-horizontal">
                                ...
                                <div class="card-body card-block">
                                    ...
                                    <div class="row form-group">
                                        <div class="col col-md-3">
                                            <label for="type" class=" form-control-label">Thể Loại Note :</label>
                                        </div>
                                        <div class="col-12 col-md-9">
                                            <p id="type">${note.noteType.name_note}</p>
                                        </div>
                                    </div>

                                    <div class="row form-group">
                                        <div class="col col-md-3">
                                            <label for="date" class=" form-control-label">Thời Gian Viết :</label>
                                        </div>
                                        <div class="col-12 col-md-9">
                                            <p id="date">${note.datetime}</p>
                                        </div>
                                    </div>
                                    <div class="row form-group">
                                        <div class="col col-md-3">
