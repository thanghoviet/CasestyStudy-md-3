                            ...
                            <div class="table-responsive table-responsive-data2">
                                <table class="table table-data2">
                                    ...
                                    <tr>
                                        ...
                                        <th><a href="/type?action=sortId">STT</a></th>
                                        <th><a href="/type?action=sortNameNote">Thể Loại</a></th>
                                        <th><a href="/type?action=sortDescription">Mô tả</a></th>
                                        <th></th>
                                    </tr>
                                    </thead>

                                    <c:forEach var="noteType" items="${listNoteType1}">
                                        <tbody>
                                        <tr class="spacer"></tr>
                                        <tr class="tr-shadow">
                                            <td>
                                            ...
                                            <td><c:out value="${noteType.id}"/></td>
                                            <td>
                                                <span class="block-email"><c:out value="${noteType.name_note}"/></span>
                                            </td>
                                            <td class="desc"><c:out value="${noteType.description}"/></td>
                                            <td>
                                                <div class="table-data-feature">
                                                    <a class="item" data-toggle="tooltip" data-placement="top"
                                                            title="Edit" href="/type?action=edit&id=${noteType.id}">
                                                            <i class="zmdi zmdi-edit"></i>
                                                    </a>
<%--                                                    <button class="item" data-toggle="tooltip" data-placement="top"--%>
<%--                                                            title="Delete">--%>
<%--                                                        <a href="/type?action=delete&id=${noteType.id}"> <i class="zmdi zmdi-delete"></i></a>--%>
<%--                                                        <a href="#" onclick="deleteNote(${noteType.id})"--%>
...
<%--            let showMessage = confirm("Do you want to delete this type ?");--%>
<%--            if (showMessage) {--%>
